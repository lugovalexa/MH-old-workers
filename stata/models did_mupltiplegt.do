...
* Regressions
did_multiplegt eurod mergeid_encoded year work_horizon_change_minimum, controls(age nb_children nb_grandchildren partnerinhh thinclog life_insurance sphus chronic) robust_dynamic dynamic(1) weight(cciw) cluster(cell1_encoded)

...
clear
set linesize 100
cd "/Users/dmitrii/Documents/Sasha/"
adopath ++ "/Users/dmitrii/Documents/Sasha/"
local data "/Users/dmitrii/Documents/Sasha/data/"
*-----------------------------------------------------------------------------
global wi 4
global wf 6
global cc "SE"
...
sreweight `list_CVar' if nowi!=1 & dw_w`wi'!=.,   ///
	...
	dfunction(c) upbound(10) lowbound(.01)  ///
	niter(200)
*-----------------------------------------------------------------------------

save "data/mydata_long_ind_SE.dta", replace

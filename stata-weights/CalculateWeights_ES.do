...
qui gen region = .
qui replace region=0 if nuts1=="ES1"
qui replace region=1 if nuts1=="ES2"
qui replace region=2 if nuts1=="ES3"
qui replace region=3 if nuts1=="ES4"
qui replace region=4 if nuts1=="ES5"
qui replace region=5 if nuts1=="ES6"
qui replace region=6 if nuts1=="ES7"
...
save "data/mydata_long_ind_ES.dta", replace
